...
const FICHAS_INFO=[
 {name:"Combo accesorio",type:"Sin clasificar",description:"Ficha que te permite elegir si Randes se pone peluca, gorro de papa Noel, mascará Halloween 2023/2025 o gorra."},
 {name:"Inspector de motes",type:"Sin clasificar",description:"Ficha que te permite ponerle un mote a un pokémon, usar antes de tirar dados en no lockes y ruleta en lockes. El pokemon debe estar atrapado al usarse."},
 {name:"Himno del chat",type:"Sin clasificar",description:"Ficha que te permite poner una canción del discord en el chat."},
 {name:"Speed Art",type:"Sin clasificar",description:"Puedes seleccionar un pokemon del equipo o pc el cual será dibujado en 1 min y colocado en el marco."},
 {name:"Susurros Futuristas",type:"Sin clasificar",description:"Permite pedirle un entretenimiento del futuro (chiste, poema, haiku o similares con un pokemon a la ia y que randes lo lea)."},
 {name:"Tototo Star",type:"Sin clasificar",description:"Permite pedir un tototo de la lista para colocarse en el directo. Esta ficha es compatible con tototo fiel seguidor. Y durante el tototo day no posee límite de cantidad de uso, pero sí de usuario."}
];
const FICHA_SONGS={
...
const TOTOTOS=[
 ["Tototo","a Tototo.png"],["Tototo Astrobot","Tototo Astrobot.png"],["Tototo Batman","Tototo Batman.png"],["Tototo Boxeador","Tototo Boxeador.png"],["Tototo Chikorita","Tototo CHIKORITA.png"],["Tototo Cecil Stedman","Tototo Cecil stedman.png"],["Tototo Conquest","Tototo Conquest.png"],["Tototo Cyndaquil","Tototo Cyndaquill.png"],["Tototo Dalmata","Tototo Dalmata.png"],["Tototo Dos Caras","Tototo Dos caras.png"],["Tototo.EXE","Tototo EXE.png"],["Tototo Fan NotPikachu FC","Tototo Fan NotPikachuFC.png"],["Tototo Gato","Tototo Gato.png"],["Tototo Goomy","Tototo Goomy.png"],["Tototo Hades","Tototo Hades disney.png"],["Tototo Kratos","Tototo Kratos.png"],["Tototo Profesor Layton","Tototo Layton.png"],["Tototo Mega Malamar","Tototo MEGA malamar.png"],["Tototo Matriosca Desplegada","Tototo Matriosca desplegada.png"],["Tototo Matriosca","Tototo Matriosca.png"],["Tototo Mickey Mouse","Tototo Mickey mouse.png"],["Tototo Mini","Tototo Mini.png"],["Tototo NotTototo","Tototo NOTTOTOTO.png"],["Tototo Nzinga Mvemba","Tototo Nzinga Mvemba CIV.png"],["Tototo Pidove","Tototo Pidove.png"],["Tototo Ragnar Vikingson","Tototo Ragnar Vikingson.png"],["Tototo Santa Claus","Tototo Santa Claus.png"],["Tototo Shenron","Tototo Shenron.png"],["Tototo Silvally (electrico)","Tototo Silvally electrico.png"],["Tototo TNT","Tototo TNT.png"],["Tototo Yoda","Tototo Yoda.png"],["Tototo Yzma","Tototo Yzma.png"],
 ["Tototo Abeja","Tototo abeja.png"],["Tototo Albino","Tototo albino.png"],["Tototo Alegria","Tototo alegria.png"],["Tototo Amistad Brillante","Tototo amistad brillante.png"],["Tototo Argabot","Tototo argabot.png"],["Tototo Babariano","Tototo babariano.png"],["Tototo Ban","Tototo ban.png"],["Tototo Banana","Tototo banana.png"],["Tototo Boo (disfrazada)","Tototo boo disfrazada.png"],["Tototo Boo","Tototo boo.png"],["Tototo Buda","Tototo buda.png"],["Tototo Sr. Buenavista","Tototo buenavista.png"],["Tototo Calabaza (halloween)","Tototo calabaza.png"],["Tototo Cartero","Tototo cartero.png"],["Tototo Charco","Tototo charco.png"],["Tototo Chef","Tototo chef.png"],["Tototo Codigo Cero","Tototo codigo cero.png"],["Tototo Conejo","Tototo conejo.png"],["Tototo Confuso","Tototo confuso.png"],["Tototo Cupido","Tototo cupido.png"],["Tototo Demonio","Tototo demonio.png"],["Tototo Dios Cerdo","Tototo dios cerdo.png"],["Tototo Ditto","Tototo ditto.png"],["Tototo Dumbledore","Tototo dumbledore.png"],["Tototo Elegante","Tototo elegante.png"],["Tototo Fantasma","Tototo fantasma.png"],["Tototo Freezer (Golden)","Tototo freezer golden.png"],["Tototo Freezer","Tototo freezer.png"],["Tototo Galactico","Tototo galactico.png"],["Tototo Gamer","Tototo gamer.png"],["Tototo Gandalf","Tototo gandalf.png"],["Tototo Gladiador","Tototo gladiador.png"],["Tototo Gojo","Tototo gojo.png"],["Tototo Goku","Tototo goku.png"],["Tototo Goku (SSJ)","Tototo goku ssj.png"],["Tototo Goku (SSJ Blue)","Tototo goku ssjblue.png"],["Tototo Granjero","Tototo granjero.png"],["Tototo Gun","Tototo gun.png"],["Tototo Hollow","Tototo hollow.png"],["Tototo Homer Simpson","Tototo homer.png"],["Tototo Inkay","Tototo inkay.png"],["Tototo Invencible","Tototo invencible.png"],["Tototo Indiana Jones","Tototo jones.png"],["Tototo Joven Chano","Tototo joven chano.png"],["Tototo Juez","Tototo juez.png"],["Tototo Enlace Kuriboh","Tototo kuriboh enlace.png"],["Tototo Kuriboh","Tototo kuriboh.png"],["Tototo L","Tototo l.png"],["Tototo Like","Tototo like.png"],["Tototo Lt. Surge American Lover (equipo)","Tototo lt surge american lover and team.png"],["Tototo Lt. Surge American Lover","Tototo lt surge american lover.png"],["Tototo Lt. Surge","Tototo lt surge.png"],["Tototo Luffy","Tototo luffy.png"],["Tototo Luigi","Tototo luigi.png"],["Tototo Malamar","Tototo malamar.png"],["Tototo Mario","Tototo mario.png"],["Tototo Maximillion Pegasus","Tototo maximillion.png"],["Tototo Militar","Tototo militar.png"],["Tototo Mimir (peluche NotPikachu)","Tototo mimir.png"],["Tototo Mimir (peluche lapras)","Tototo mimir2.png"],["Tototo Ash Ketchum","Tototo mostaza.png"],["Tototo Odin (marvel)","Tototo odin.png"],["Tototo Paparazzi","Tototo paparazzi.png"],["Tototo Patricio","Tototo patricio.png"],["Tototo Patricio (carpintero)","Tototo patrico carpintero.png"],["Tototo Piccolo","Tototo piccolo.png"],["Tototo Napoleon","Tototo poleon.png"],["Tototo Policia","Tototo policia.png"],["Tototo Profesor","Tototo profe.png"],["Tototo Rey","Tototo rey.png"],["Tototo Rico","Tototo rico.png"],["Tototo Rodri","Tototo rodri.png"],["Tototo Roland","Tototo roland.png"],["Tototo Sad","Tototo sad.png"],["Tototo Sectoide (gollum esquinero)","Tototo sectoide-golum.png"],["Tototo Shiny","Tototo shiny.png"],["Tototo Shovel","Tototo shovel.png"],["Tototo Slakoth","Tototo slakoth.png"],["Tototo Sol teletubbies","Tototo sol teletubbies.png"],["Tototo Gafas de Sol","Tototo sol.png"],["Tototo Solomon Muto","Tototo solomon muto.png"],["Tototo Spiderman","Tototo spiderman.png"],["Tototo Sprigatito","Tototo sprigatito.png"],["Tototo Stand (The World)","Tototo stand the world.png"],["Tototo Suertudo","Tototo suertudo.png"],["Tototo Sukuna (Megumi) con Mahogara","Tototo sukuna megumi (mahogara).png"],["Tototo Sukuna (Megumi)","Tototo sukuna megumi.png"],["Tototo Sunkern","Tototo sunkern.png"],["Tototo Surfista","Tototo surf.png"],["Tototo Laa-Laa","Tototo teletubbie amarillo.png"],["Tototo Snampery","Tototo tilde snampery.png"],["Tototo Totoro","Tototo totoro.png"],["Tototo Chambeador","Tototo trabajo.png"],["Tototo Trubbish","Tototo trubbish.png"],["Tototo Urgot","Tototo urgot.png"],["Tototo Wooper (Paldea)","Tototo wooper paldea.png"],["Tototo Wooper","Tototo wooper.png"],["Tototo Yugi Muto","Tototo yugi.png"],["Tototo Zoroark","Tototo zoroark.png"],["Tototo Burbuja","tototo Burbuja.png"],["Tototo Cactus-Bellota","tototo Cactus-Bellota.png"],["Tototo Chat GPT","tototo ChatGpt.png"],["Tototo Pétalo-Bombón","tototo Pétalo-Bombón.png"],["Tototo Zielinski","tototo Zielinski.png"],["Tototo Big Mon","tototo big mon.png"],["Tototo Phione","tototo phione  anuprinces.png"],["Tototo Presentador","tototo presentador.png"],["Tototo Doctor Eggman","tototo robotnick.png"],["Tototo Fan Tototo FC lanzapapas","Tototo Fan tototo FC lanzapapas.png"],["Tototo NotPikachu","Tototo Notpikachu.png"],["Tototo Hojafail","Tototo hojafail.png"],["Tototo Fotopie","Tototo fotopie.png"],["Tototo Silvally","Tototo Silvally.png"],["Tototo Silvally (agua)","Tototo Silvally agua.png"],["Tototo Silvally (acero)","Tototo Silvally acero.png"],["Tototo Delibird","Tototo delibird.png"],["Tototo Victini","Tototo victini.png"],["Tototo Minion","Tototo minion.png"],["Tototo Baby Plum","Tototo baby plum.png"],["Tototo Numemon","Tototo numemon.png"],["Tototo Thragg","Tototo Thragg.png"],["Tototo Randes","Tototo Randes.png"],["Tototo Centauro","Tototo centauro.png"],["Tototo Centauro con pantalones","Tototo centauro pantalones.png"],["Tototo Kecleon","Tototo kecleon.png"],["Tototo Orco (WOW)","Tototo orcoWOW.png"],["Tototo Paceo","Tototo Paceo.png"],["Tototo Tyranastar","Tototo tyranastar.png"],["Tototo Murloc","Tototo murloc.png"],["Tototo Cumpleaños","Tototo cumpleanos.png"],["Tototo Silvally (fuego)","Tototo Silvally fuego.png"],["Tototo Silvally (bicho)","Tototo Silvally bicho.png"],["Tototo Silvally (dragon)","Tototo Silvally dragon.png"],["Tototo Silvally (fantasma)","Tototo Silvally fantasma.png"],["Tototo Silvally (hada)","Tototo Silvally hada.png"],["Tototo Silvally (hielo)","Tototo Silvally ice.png"],["Tototo Silvally (lucha)","Tototo Silvally lucha.png"],["Tototo Silvally (planta)","Tototo Silvally planta.png"],["Tototo Silvally (psiquico)","Tototo Silvally psiquico.png"],["Tototo Silvally (roca)","Tototo Silvally roca.png"],["Tototo Silvally (siniestro)","Tototo Silvally siniestro.png"],["Tototo Silvally (tierra)","Tototo Silvally tierra.png"],["Tototo Silvally (veneno)","Tototo Silvally veneno.png"],["Tototo Silvally (volador)","Tototo Silvally volador.png"]
...
function fichaType(name){return FICHAS_INFO.find(x=>x.name.toLowerCase()===name.toLowerCase())?.type||'Sin clasificar'}
function renderFichasInfo(){const el=document.getElementById('fichasInfoContent');if(!el)return;el.innerHTML=FICHAS_INFO.map((f,i)=>{const songs=f.name==='Himno del chat'?Object.entries(FICHA_SONGS).map(([g,arr])=>`<details class="ficha-details"><summary>${escape(g)} <span>${arr.length} canciones</span></summary><ul>${arr.map(x=>`<li>${escape(x)}</li>`).join('')}</ul></details>`).join(''):'';const tots=f.name==='Tototo Star'?`<details class="ficha-details tototo-details"><summary>Lista de Tototos <span>${TOTOTOS.length} Tototos</span></summary><div class="tototo-grid">${TOTOTOS.map(t=>`<figure class="tototo-card"><img src="${t.url}" alt="${escape(t.name)}" loading="lazy" onerror="this.style.opacity='.25'"><figcaption>${escape(t.name)}</figcaption></figure>`).join('')}</div></details>`:'';return `<article class="ficha-card"><div class="ficha-card-head"><div><p class="eyebrow">FICHA ${i+1}</p><h2>${escape(f.name)}</h2></div><span class="ficha-type">${escape(f.type)}</span></div><p>${escape(f.description)}</p>${songs}${tots}</article>`}).join('')}
function renderFichasUsers(){const el=document.getElementById('fichasUsersContent');if(!el)return;const totals=fichaTotals();const names=Object.keys(totals).sort((a,b)=>a.localeCompare(b,'es'));el.innerHTML=`<div class="ficha-user-tools"><input id="fichaUserSearch" type="search" placeholder="Buscar usuario..." autocomplete="off"></div><div id="fichaUserList" class="ficha-user-list">${names.map(u=>`<article class="ficha-user-card"><h3>${escape(u)}</h3><div class="ficha-inventory">${Object.entries(totals[u]).filter(([,n])=>n>0).sort((a,b)=>a[0].localeCompare(b[0],'es')).map(([f,n])=>`<div><span>${escape(f)}</span><strong>${n}</strong></div>`).join('')||'<p class="muted">Sin fichas disponibles.</p>'}</div></article>`).join('')||'<div class="empty">No hay movimientos de fichas.</div>'}</div>`;document.getElementById('fichaUserSearch').oninput=e=>{const q=e.target.value.toLowerCase();document.querySelectorAll('.ficha-user-card').forEach(c=>c.style.display=c.querySelector('h3').textContent.toLowerCase().includes(q)?'':'none')}}
function renderFichasStats(){const el=document.getElementById('fichasStatsContent');if(!el)return;const months=fichaMonthlyStats(),keys=Object.keys(months).sort().reverse();const current=keys[0];const data=current?months[current]:{gained:0,used:0,byUser:{},byFicha:{}};const topUser=Object.entries(data.byUser).sort((a,b)=>b[1]-a[1])[0];const topFicha=Object.entries(data.byFicha).sort((a,b)=>b[1]-a[1])[0];const usedByUser={};fichas.forEach(r=>{if(fichaDate(r).startsWith(current)&&fichaMove(r)<0){const u=fichaUser(r);if(u)usedByUser[u]=(usedByUser[u]||0)+Math.abs(fichaMove(r))}});const topUsed=Object.entries(usedByUser).sort((a,b)=>b[1]-a[1])[0];const bestMonth=keys.map(k=>[k,months[k].gained]).sort((a,b)=>b[1]-a[1])[0];const allTypes={};Object.keys(data.byFicha).forEach(f=>{const t=fichaType(f);allTypes[t]=(allTypes[t]||0)+data.byFicha[f]});el.innerHTML=`<div class="ficha-stat-tools"><label>Mes<select id="fichaStatsMonth">${keys.map(k=>`<option value="${k}" ${k===current?'selected':''}>${escape(fichaMonthLabel(k))}</option>`).join('')}</select></label></div><div id="fichaStatsBody" class="ficha-stats-grid"><div class="ficha-stat-card"><span>Fichas ganadas</span><strong>${data.gained}</strong></div><div class="ficha-stat-card"><span>Fichas usadas</span><strong>${data.used}</strong></div><div class="ficha-stat-card"><span>Quién ganó más</span><strong>${topUser?escape(topUser[0]):'—'}</strong><small>${topUser?topUser[1]+' fichas':'—'}</small></div><div class="ficha-stat-card"><span>Quién usó más</span><strong>${topUsed?escape(topUsed[0]):'—'}</strong><small>${topUsed?topUsed[1]+' fichas':'—'}</small></div><div class="ficha-stat-card"><span>Mes con más ganancias</span><strong>${bestMonth?escape(fichaMonthLabel(bestMonth[0])):'—'}</strong><small>${bestMonth?bestMonth[1]+' fichas ganadas':'—'}</small></div><div class="ficha-stat-card"><span>Ficha más ganada</span><strong>${topFicha?escape(topFicha[0]):'—'}</strong><small>${topFicha?topFicha[1]+' fichas':'—'}</small></div></div><div class="ficha-panel"><h3>Por tipo</h3><div class="ficha-type-list">${Object.entries(allTypes).sort((a,b)=>b[1]-a[1]).map(([t,n])=>`<div><span>${escape(t)}</span><strong>${n}</strong></div>`).join('')||'<span class="muted">Sin datos.</span>'}</div></div>`;document.getElementById('fichaStatsMonth').onchange=e=>renderFichasStatsMonth(e.target.value)}
function renderFichasStatsMonth(month){const el=document.getElementById('fichaStatsBody');if(!el)return;const m=fichaMonthlyStats()[month]||{gained:0,used:0,byUser:{},byFicha:{}};const topUser=Object.entries(m.byUser).sort((a,b)=>b[1]-a[1])[0],topFicha=Object.entries(m.byFicha).sort((a,b)=>b[1]-a[1])[0];const types={};Object.entries(m.byFicha).forEach(([f,n])=>{const t=fichaType(f);types[t]=(types[t]||0)+n});el.innerHTML=`<div class="ficha-stat-card"><span>Fichas ganadas</span><strong>${m.gained}</strong></div><div class="ficha-stat-card"><span>Fichas usadas</span><strong>${m.used}</strong></div><div class="ficha-stat-card"><span>Quién ganó más</span><strong>${topUser?escape(topUser[0]):'—'}</strong><small>${topUser?topUser[1]+' fichas':'—'}</small></div><div class="ficha-stat-card"><span>Quién usó más</span><strong>${topUsed?escape(topUsed[0]):'—'}</strong><small>${topUsed?topUsed[1]+' fichas':'—'}</small></div><div class="ficha-stat-card"><span>Mes con más ganancias</span><strong>${bestMonth?escape(fichaMonthLabel(bestMonth[0])):'—'}</strong><small>${bestMonth?bestMonth[1]+' fichas ganadas':'—'}</small></div><div class="ficha-stat-card"><span>Ficha más ganada</span><strong>${topFicha?escape(topFicha[0]):'—'}</strong><small>${topFicha?topFicha[1]+' fichas':'—'}</small></div><div class="ficha-panel wide"><h3>Por tipo</h3><div class="ficha-type-list">${Object.entries(types).sort((a,b)=>b[1]-a[1]).map(([t,n])=>`<div><span>${escape(t)}</span><strong>${n}</strong></div>`).join('')||'<span class="muted">Sin datos.</span>'}</div></div>`}
function renderFichasHistory(){const el=document.getElementById('fichasHistoryContent');if(!el)return;const months=[...new Set(fichas.map(fichaDate).filter(Boolean).map(d=>d.slice(0,7)))].sort().reverse();const current=selectedFichasMonth||months[0]||'';el.innerHTML=`<div class="ficha-stat-tools"><label>Mes<select id="fichaHistoryMonth">${months.map(m=>`<option value="${m}" ${m===current?'selected':''}>${escape(fichaMonthLabel(m))}</option>`).join('')}</select></label></div><div id="fichaHistoryList" class="ficha-history-list"></div>`;const draw=()=>{const m=document.getElementById('fichaHistoryMonth')?.value||current;selectedFichasMonth=m;const rows=fichas.filter(r=>fichaDate(r).startsWith(m)).sort((a,b)=>fichaDate(b).localeCompare(fichaDate(a)));document.getElementById('fichaHistoryList').innerHTML=rows.map(r=>{const n=fichaMove(r);return `<article class="ficha-history-row"><div class="ficha-movement ${n>=0?'positive':'negative'}">${n>0?'+':''}${n}</div><div><strong>${escape(fichaUser(r))}</strong><span>${escape(fichaName(r))}</span><small>${escape(fichaInfoExtra(r)||'Sin información extra')}</small></div><time>${escape(fichaDate(r))}</time></article>`}).join('')||'<div class="empty">No hay movimientos en este mes.</div>'};document.getElementById('fichaHistoryMonth').onchange=draw;draw()}
